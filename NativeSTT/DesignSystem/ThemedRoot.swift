...
/// live. The base `foregroundStyle` matters just as much: it means a control
/// whose label colour we don't set explicitly inherits a theme colour rather
/// than a system default that may be for the opposite appearance.
