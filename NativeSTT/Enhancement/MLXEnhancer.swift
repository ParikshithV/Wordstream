...
final class MLXEnhancer: TextEnhancer {
    private let log = Logger(subsystem: "app.nativestt", category: "mlx")
    ...
    var unavailableReason: String? {
        get async {
            isModelDownloaded ? nil : "The local model hasn't been downloaded yet. Download it in Settings → AI."
        }
    }
